        ...
        <div>
            <div className="navbar">
                ...
                <div id="navbar-right-container">
                    ...
                    <a href="https://docdro.id/segTDXa" target="_blank" className="navbar-link">Resume</a>
            ...
            <div className="welcome-container-parent">
                ...
                <h3 id="personal-introduction">I am a <b>full-stack web developer</b> with a passion for building beautiful and user-friendly experiences. Enjoy looking at my portfolio! </h3>
            ...
            <Element name="portfolio">
                <div className="portfolio-parent-container">
                    ...
                    <div className="portfolio-right-project">
                        <a href="https://marcoriesgo01.github.io/Recipe-Discovery/" target="_blank" className="project-card-link">
                            <div className="project-card">
                                <div className="project-card-left-container">
